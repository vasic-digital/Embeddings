#!/usr/bin/env bash
# embeddings_compile_challenge.sh - Validates Embeddings module compilation and code quality
set -euo pipefail
...
echo "Test: Module name is digital.vasic.embeddings"
if grep -q "^module digital.vasic.embeddings$" "${MODULE_DIR}/go.mod"; then
    pass "Module name is digital.vasic.embeddings"
else
