# Embeddings - Generic, reusable Go module for text embedding generation across multiple providers.
# Module: digital.vasic.embeddings
...
challenge:
	../challenges/scripts/embeddings_challenge.sh 2>/dev/null || echo "No challenge script"

help:
	@echo "Embeddings - Generic, reusable Go module for text embedding generation across multiple providers."
	@echo ""
	@echo "Build & Test:"
